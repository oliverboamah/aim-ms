...
require 'activity/modal_add.php';
require 'activity/modal_edit.php';
?>
...
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <button href="#" class="btn btn-secondary" data-toggle="modal" data-target="#add_forestry">
