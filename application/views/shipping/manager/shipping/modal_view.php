<div class="modal fade" id="view_shipping" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Shipping Activity Record</h4>
                    </div>
                    <form id="view_shipping_form" enctype="multipart/form-data" class="form-horizontal form-material" method="post"
                          action="">
                        <div class="modal-body">
                        <div class="form-group">
                                <label class="col-md-12">InCharge</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="combined_container" id="combined_container"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Container no.</label>
                                <div class="col-md-12">
                                <input type="text" name="container_no" id="container_no"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Number of Pieces</label>
                                <div class="col-md-12">
                                    <input type="number" name="num_pieces" id="num_pieces"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">CBM</label>
                                <div class="col-md-12">
                                    <input type="number" name="cbm" id="cbm"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            ...
                            <label class="col-md-12">Buyer CBM</label>
                                <div class="col-md-12">
                                    <input type="number" name="buyer_cbm" id="buyer_cbm"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Draft bill no.</label>
                                <div class="col-md-12">
                                    <input type="text" name="draft_bill_no" id="draft_bill_no"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Local Charges</label>
                                <div class="col-md-12">
                                    <input type="number" name="local_charge" id="local_charge"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">OBL/PHYTO/CO</label>
                                <div class="col-md-12">
                                    <input type="text" name="obl" id="obl"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">OBL no.</label>
                                <div class="col-md-12">
                                    <input type="text" name="obl_no" id="obl_no"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Tracking</label>
                                <div class="col-md-12">
                                    <input type="date" id="date_shipping"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                        </div>
