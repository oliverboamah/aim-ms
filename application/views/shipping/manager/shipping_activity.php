...
require 'shipping/modal_add.php';
require 'shipping/modal_edit.php';
...
?>
                           ...
                           <br/>
                           <button href="#" class="btn btn-secondary" data-toggle="modal" data-target="#add_shipping">
                                Add New Shipping Record</button><br/><br/>
                                    <!-- Export Data -->
    ...
    echo "
                                                        <tr>
                                                            ...
                                                            <a style='margin-right: 10px;' title='Edit' 
                                                             href='' class='link edit_shipping_link' data-toggle='modal' data-target='#edit_shipping' title='Edit'
                                                             data-shipping_id='$record->shipping_id' 
                                                             data-combined_container='$record->combined_container' data-buyer_name='$record->buyer_name' 
                                                             data-seal_no='$record->seal_no' data-weight='$record->weight'
                                                             data-container_no='$record->container_no' data-buyer_cbm='$record->buyer_cbm' 
