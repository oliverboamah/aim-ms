<div class="modal fade" id="view_transport" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Update Transport Activity Record</h4>
                    </div>
                    <form id="view_transport_form" enctype="multipart/form-data" class="form-horizontal form-material" method="post"
                          action="">
                        <div class="modal-body">
                            ...
                            <label class="col-md-12">Credit Date</label>
                                <div class="col-md-12">
                                <input type="date" id="date_credit" name="date_credit"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Credit Paid by</label>
                                <div class="col-md-12">
                                    <input type="text" id="credit_paid_by" name="credit_paid_by"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Loading Date</label>
                                <div class="col-md-12">
                                    <input type="date" id="date_loading" name="date_loading"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Container Pickup Fee</label>
                                <div class="col-md-12">
                                    <input type="number" id="container_pickup_fee" name="container_pickup_fee"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Picking Place</label>
                                <div class="col-md-12">
                                    <input type="text" id="picking_place" name="picking_place"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            ...
                            <label class="col-md-12">2nd Container No.</label>
                                <div class="col-md-12">
                                    <input type="text" id="container_no2" name="container_no2"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">2nd Container Seal No.</label>
                                <div class="col-md-12">
                                    <input type="text" id="seal_no2" name="seal_no2"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Offloading Place</label>
                                <div class="col-md-12">
                                    <input type="text" id="offloading_place" name="offloading_place"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">2nd Container Driver</label>
                                <div class="col-md-12">
                                    <input type="text" id="driver_name2" name="driver_name2"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            ...
                            <label class="col-md-12">Driver No.</label>
                                <div class="col-md-12">
                                    <input type="tel" id="driver_no" name="driver_no"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">TPT Name</label>
                                <div class="col-md-12">
                                    <input type="text" id="tpt_name" name="tpt_name"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Total TPT</label>
                                <div class="col-md-12">
                                    <input type="double" id="total_tpt" name="total_tpt"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Advance Date</label>
                                <div class="col-md-12">
                                    <input type="date" id="date_advance" name="date_advance"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Additional Payment</label>
                                <div class="col-md-12">
                                    <input type="number" id="extra_payment" name="extra_payment"
                                           class="form-control form-control-line" disabled >
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">After Loading Expenses</label>
                                <div class="col-md-12">
                                    <input type="number" id="after_loading" name="after_loading"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Road Exp/Council Ticket</label>
                                <div class="col-md-12">
                                    <input type="number" id="road_expenses" name="road_expenses"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-12">Balance Left</label>
                                <div class="col-md-12">
                                    <input type="number" id="balance_left" name="balance_left"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-12">Balance Left Paid By</label>
                                <div class="col-md-12">
                                    <input type="text" id="balance_left_paid_by" name="balance_left_paid_by"
                                           class="form-control form-control-line" disabled>
                                </div>
                            </div>
                            <div class="form-group">
