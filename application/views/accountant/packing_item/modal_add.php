                    ...
                    <form id="packing_form" enctype="multipart/form-data" class="form-horizontal form-material" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            <label class="col-md-12">Thickness</label>
                                <div class="col-md-12">
                                        <input min="0" type="number" name="thickness" 
                                           class="form-control form-control-line" required >
                            ...
                            <label class="col-md-12">Length</label>
                                <div class="col-md-12">
                                        <input min="0" type="number" name="length" 
                                           class="form-control form-control-line" required >
                            ...
                            <label class="col-md-12">Number of Pieces</label>
                                <div class="col-md-12">
                                        <input min="0" type="number" name="num_pieces" 
                                           class="form-control form-control-line" required >
