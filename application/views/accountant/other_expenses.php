...
<div class="dashboard-main-wrapper">
	...
	require 'other_expenses/modal_add.php';
	require 'other_expenses/modal_edit.php';
	?>
	<div class="dashboard-wrapper" style="position: relative;">
		<div class="container-fluid dashboard-content">
					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="page-header" id="top">
								...
								<?php
								require 'other_expenses/status.php';
								?>
							</div>
						</div>
					</div>
                                 ...
                                 <?php echo $total_amount_in_year; ?></span>
                                   ...
                                   <!-- Pie Chart -->
									...
									<button style="float: right" class="btn btn-secondary" data-toggle="modal" data-target="#add_expense">
										<i class="fa fa-plus-circle"></i> Add Expense Record
									</button>
									<br/><br/>
            ...
            <tr>        
               ...
               data-sender='$expense->sender' data-reciever='$expense->reciever'
               data-expense_id=$expense->expense_id data-payment_mode='$expense->payment_mode' 
