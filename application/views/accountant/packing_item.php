                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Clean Cut List Item </h2>

                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-record"><a href="#" class="breadcrumb-link">Dashboard > Clean Cut List Item</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <?php
...
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Clean Cut List Item</h5>
                            <div class="card-body">
    ...
    $('#table').DataTable({
                ...
                buttons: [
                    'colvis',
                    {
                        ...
                        messageTop: 'Clean Cut List Item',
                        text: 'Excel',
