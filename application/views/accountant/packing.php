                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Clean Cut </h2>
...
?>
                           ...
                           <br/>
                           <button href="#" style="float:right" class="btn btn-secondary" data-toggle="modal" data-target="#add_packing">
                           <i class="fa fa-plus-circle"></i> Add New Packing List Item</button><br/><br/>
...
foreach ($packages as $package) {
    ...
    $url_view = base_url('Accountant/packing_item/' . $package->package_id);
    $url_delete = base_url('Package/delete_permission/' . $package->package_id);
