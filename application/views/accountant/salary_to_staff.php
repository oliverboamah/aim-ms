                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Record Salary Paid to Staff Member</h2>

                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Record salary allocated to a staff member</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <?php
    ...
    if( !($staff_member->location == 'Main Office' 
        && $staff_member->role == 'Administrator') ){
            ...
            <td>$staff_member->staff_id</td>
                ...
                <a style='margin-right: 10px;' data-staff_id=$staff_member->staff_id data-name='$staff_member->name' 
                ...
                data-date_employed='$staff_member->date_employed'
                 href='' class='link add_salary' data-toggle='modal' data-target='#add_salary' title='Record Salary'>
                <span class='badge badge-warning'>
                <i class='fas fa-money-bill-alt'></i>
                Record salary</span></a>
...
$(document).ready( function() {
    ...
    $('#table').on('click', '.add_salary', function() {

        // update form action
        staff_id = $(this).data('staff_id');
        form = $('#add_salary_form');
