...
?>
                    ...
                    <div class="tab-outline" >
                            ...
                            <h5 class="card-header">Total Logs (All Pieces)</h5>
                            <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Logs in <?php echo date('Y') ?> <span class="badge badge-primary">
                                 <?php echo $total_logs_in_year; ?></span>
                                </span>
                            </ol>
                                <?php
echo "
...
echo "
                                   <!-- Pie Chart -->
                                    <div
                                    data-jan_total_logs=$jan_total_logs
                                    data-feb_total_logs=$feb_total_logs
                                    data-mar_total_logs=$mar_total_logs
                                    data-apr_total_logs=$apr_total_logs
                                    data-may_total_logs=$may_total_logs
                                    data-jun_total_logs=$jun_total_logs
                                    data-jul_total_logs=$jul_total_logs
                                    data-aug_total_logs=$aug_total_logs
                                    data-sep_total_logs=$sep_total_logs
                                    data-oct_total_logs=$oct_total_logs
                                    data-nov_total_logs=$nov_total_logs
                                    data-dec_total_logs=$dec_total_logs
                                    id='piechart_3d111' class='card-body'>
                                    </div>
                                    ";
?> 
               
               
                                   <h5 class="card-header">Total Amount (All Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
...
<h5 class="card-header">Total Logs (Straight Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Logs in <?php echo date('Y') ?> <span class="badge badge-primary">
                                 <?php echo $total_logs_straight_in_year; ?></span>
                                </span>
                            </ol>
                                <?php
...
echo "
                                   ...
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                    $jan_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-danger mt-1'>
                                   February
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $feb_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-primary mt-1'>
                                   March
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $mar_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-info mt-1'>
                                    April
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $apr_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-dark mt-1'>
                                   May
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $may_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-light mt-1'>
                                   June
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $jun_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-secondary mt-1'>
                                   July
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                    $jul_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-primary mt-1'>
                                   August
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $aug_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-danger mt-1'>
                                   September
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $sep_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-success mt-1'>
                                    October
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $oct_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-dark mt-1'>
                                   November
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $nov_total_logs_straight
                                   </a>
                                   <a href='' class='btn btn-xs btn-outline-info mt-1'>
                                   December
                                   </a>
                                   <a href='' class='btn btn-xs btn-warning mt-1'>
                                   $dec_total_logs_straight
                                   </a>
                                   ";
...
echo "
                                   <!-- Pie Chart -->
                                    <div
                                    data-jan_total_logs_straight=$jan_total_logs_straight
                                    data-feb_total_logs_straight=$feb_total_logs_straight
                                    data-mar_total_logs_straight=$mar_total_logs_straight
                                    data-apr_total_logs_straight=$apr_total_logs_straight
                                    data-may_total_logs_straight=$may_total_logs_straight
                                    data-jun_total_logs_straight=$jun_total_logs_straight
                                    data-jul_total_logs_straight=$jul_total_logs_straight
                                    data-aug_total_logs_straight=$aug_total_logs_straight
                                    data-sep_total_logs_straight=$sep_total_logs_straight
                                    data-oct_total_logs_straight=$oct_total_logs_straight
                                    data-nov_total_logs_straight=$nov_total_logs_straight
                                    data-dec_total_logs_straight=$dec_total_logs_straight
                                    id='piechart_3d112' class='card-body'>
                                    </div>
                                    ";
?>


<h5 class="card-header">Total Amount (Straight Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Amount in <?php echo date('Y') ?> <span class="badge badge-primary">
...
<h5 class="card-header">Total Logs (Bend Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Logs in <?php echo date('Y') ?> <span class="badge badge-primary">
                                 <?php echo $total_logs_bend_in_year; ?></span>
                                </span>
                            </ol>
                                <?php
...
echo "
                                   <!-- Pie Chart -->
                                    <div
                                    data-jan_total_logs_bend=$jan_total_logs_bend
                                    data-feb_total_logs_bend=$feb_total_logs_bend
                                    data-mar_total_logs_bend=$mar_total_logs_bend
                                    data-apr_total_logs_bend=$apr_total_logs_bend
                                    data-may_total_logs_bend=$may_total_logs_bend
                                    data-jun_total_logs_bend=$jun_total_logs_bend
                                    data-jul_total_logs_bend=$jul_total_logs_bend
                                    data-aug_total_logs_bend=$aug_total_logs_bend
                                    data-sep_total_logs_bend=$sep_total_logs_bend
                                    data-oct_total_logs_bend=$oct_total_logs_bend
                                    data-nov_total_logs_bend=$nov_total_logs_bend
                                    data-dec_total_logs_bend=$dec_total_logs_bend
                                    id='piechart_3d113' class='card-body'>
                                    </div>
                                    ";
?>

<h5 class="card-header">Total Amount (Bend Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Amount in <?php echo date('Y') ?> <span class="badge badge-primary">
...
<h5 class="card-header">Total Logs (4FT Pieces)</h5>
                                  <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Logs in <?php echo date('Y') ?> <span class="badge badge-primary">
                                 <?php echo $total_logs_feet_in_year; ?></span>
                                </span>
                            </ol>
                                <?php
...
echo "
                                   <!-- Pie Chart -->
                                    <div
                                    data-jan_total_logs_feet=$jan_total_logs_feet
                                    data-feb_total_logs_feet=$feb_total_logs_feet
                                    data-mar_total_logs_feet=$mar_total_logs_feet
                                    data-apr_total_logs_feet=$apr_total_logs_feet
                                    data-may_total_logs_feet=$may_total_logs_feet
                                    data-jun_total_logs_feet=$jun_total_logs_feet
                                    data-jul_total_logs_feet=$jul_total_logs_feet
                                    data-aug_total_logs_feet=$aug_total_logs_feet
                                    data-sep_total_logs_feet=$sep_total_logs_feet
                                    data-oct_total_logs_feet=$oct_total_logs_feet
                                    data-nov_total_logs_feet=$nov_total_logs_feet
                                    data-dec_total_logs_feet=$dec_total_logs_feet
                                    id='piechart_3d114' class='card-body'>
                                    </div>
                                    ";
?>

<h5 class="card-header">Total Amount (4FT Pieces)</h5>
                                    <ol class="breadcrumb">
                                <span class="breadcrumb-item">
                                <span class="badge-dot badge-primary"></span>
                                 Total Amount in <?php echo date('Y') ?> <span class="badge badge-primary">
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart5() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Logs in January', $('#piechart_3d111').data('jan_total_logs')],
          ['Total Logs in February', $('#piechart_3d111').data('feb_total_logs')],
          ['Total Logs in March', $('#piechart_3d111').data('mar_total_logs')],
          ['Total Logs in April', $('#piechart_3d111').data('apr_total_logs')],
          ['Total Logs in May', $('#piechart_3d111').data('may_total_logs')],
          ['Total Logs in June', $('#piechart_3d111').data('jun_total_logs')],
          ['Total Logs in July', $('#piechart_3d111').data('jul_total_logs')],
          ['Total Logs in August', $('#piechart_3d111').data('aug_total_logs')],
          ['Total Logs in September', $('#piechart_3d111').data('sep_total_logs')],
          ['Total Logs in October', $('#piechart_3d111').data('oct_total_logs')],
          ['Total Logs in November', $('#piechart_3d111').data('nov_total_logs')],
          ['Total Logs in December', $('#piechart_3d111').data('dec_total_logs')],
        ]);

        var options = {
          title: 'Total Logs recorded per month in ' + new Date().getFullYear(),
          is3D: true,
        };
      ...
      function drawChart51() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Logs in January', $('#piechart_3d112').data('jan_total_logs_straight')],
          ['Total Logs in February', $('#piechart_3d112').data('feb_total_logs_straight')],
          ['Total Logs in March', $('#piechart_3d112').data('mar_total_logs_straight')],
          ['Total Logs in April', $('#piechart_3d112').data('apr_total_logs_straight')],
          ['Total Logs in May', $('#piechart_3d112').data('may_total_logs_straight')],
          ['Total Logs in June', $('#piechart_3d112').data('jun_total_logs_straight')],
          ['Total Logs in July', $('#piechart_3d112').data('jul_total_logs_straight')],
          ['Total Logs in August', $('#piechart_3d112').data('aug_total_logs_straight')],
          ['Total Logs in September', $('#piechart_3d112').data('sep_total_logs_straight')],
          ['Total Logs in October', $('#piechart_3d112').data('oct_total_logs_straight')],
          ['Total Logs in November', $('#piechart_3d112').data('nov_total_logs_straight')],
          ['Total Logs in December', $('#piechart_3d112').data('dec_total_logs_straight')],
        ]);
      ...
      function drawChart6() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Logs in January', $('#piechart_3d113').data('jan_total_logs_bend')],
          ['Total Logs in February', $('#piechart_3d113').data('feb_total_logs_bend')],
          ['Total Logs in March', $('#piechart_3d113').data('mar_total_logs_bend')],
          ['Total Logs in April', $('#piechart_3d113').data('apr_total_logs_bend')],
          ['Total Logs in May', $('#piechart_3d113').data('may_total_logs_bend')],
          ['Total Logs in June', $('#piechart_3d113').data('jun_total_logs_bend')],
          ['Total Logs in July', $('#piechart_3d113').data('jul_total_logs_bend')],
          ['Total Logs in August', $('#piechart_3d113').data('aug_total_logs_bend')],
          ['Total Logs in September', $('#piechart_3d113').data('sep_total_logs_bend')],
          ['Total Logs in October', $('#piechart_3d113').data('oct_total_logs_bend')],
          ['Total Logs in November', $('#piechart_3d113').data('nov_total_logs_bend')],
          ['Total Logs in December', $('#piechart_3d113').data('dec_total_logs_bend')],
        ]);
      ...
      function drawChart7() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Logs in January', $('#piechart_3d114').data('jan_total_logs_feet')],
          ['Total Logs in February', $('#piechart_3d114').data('feb_total_logs_feet')],
          ['Total Logs in March', $('#piechart_3d114').data('mar_total_logs_feet')],
          ['Total Logs in April', $('#piechart_3d114').data('apr_total_logs_feet')],
          ['Total Logs in May', $('#piechart_3d114').data('may_total_logs_feet')],
          ['Total Logs in June', $('#piechart_3d114').data('jun_total_logs_feet')],
          ['Total Logs in July', $('#piechart_3d114').data('jul_total_logs_feet')],
          ['Total Logs in August', $('#piechart_3d114').data('aug_total_logs_feet')],
          ['Total Logs in September', $('#piechart_3d114').data('sep_total_logs_feet')],
          ['Total Logs in October', $('#piechart_3d114').data('oct_total_logs_feet')],
          ['Total Logs in November', $('#piechart_3d114').data('nov_total_logs_feet')],
          ['Total Logs in December', $('#piechart_3d114').data('dec_total_logs_feet')],
        ]);
