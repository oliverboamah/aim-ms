                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Send Money to Staff Member</h2>

                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Allocate funds to a staff member</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <?php
...
foreach ($staff as $staff_member) {
    ...
    if( !($staff_member->department == 'Main Office' 
        && $staff_member->role == 'Administrator') ){
            ...
            <tr>
                ...
                data-department='$staff_member->department' data-role='$staff_member->role' data-address='$staff_member->address'
