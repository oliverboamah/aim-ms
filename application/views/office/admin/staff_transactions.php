                                ...
                                <div class="page-header" id="top">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">See accounts of monies sent to staff</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <?php
...
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <!-- <a href="<?php echo base_url("OfficeAdmin/transact_to_staff") ?>">
                            <button class="btn btn-secondary" >
                                Send Money to Staff Member</button>
                                </a><br/><br/> -->
...
foreach ($transactions as $transaction) {
    ...
    $url_view = base_url('OfficeAdmin/staff_accounts/' . $transaction->staff_transaction_id);
    ...
    $current_balance = $transaction->amount + $transaction->balance;
            ...
            <tr>
                ...
                <td>$transaction->recorder_name</td>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Amount Given in January', $('#piechart_3d').data('jan_total_amount')],
          ['Total Amount Given in February', $('#piechart_3d').data('feb_total_amount')],
          ['Total Amount Given in March', $('#piechart_3d').data('mar_total_amount')],
          ['Total Amount Given in April', $('#piechart_3d').data('apr_total_amount')],
          ['Total Amount Given in May', $('#piechart_3d').data('may_total_amount')],
          ['Total Amount Given in June', $('#piechart_3d').data('jun_total_amount')],
          ['Total Amount Given in July', $('#piechart_3d').data('jul_total_amount')],
          ['Total Amount Given in August', $('#piechart_3d').data('aug_total_amount')],
          ['Total Amount Given in September', $('#piechart_3d').data('sep_total_amount')],
          ['Total Amount Given in October', $('#piechart_3d').data('oct_total_amount')],
          ['Total Amount Given in November', $('#piechart_3d').data('nov_total_amount')],
          ['Total Amount Given in December', $('#piechart_3d').data('dec_total_amount')],
        ]);
