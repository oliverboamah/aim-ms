  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Task', ""],
          ['Total Amount Paid in January', $('#piechart_3d').data('jan_total_amount')],
          ['Total Amount Paid in February', $('#piechart_3d').data('feb_total_amount')],
          ['Total Amount Paid in March', $('#piechart_3d').data('mar_total_amount')],
          ['Total Amount Paid in April', $('#piechart_3d').data('apr_total_amount')],
          ['Total Amount Paid in May', $('#piechart_3d').data('may_total_amount')],
          ['Total Amount Paid in June', $('#piechart_3d').data('jun_total_amount')],
          ['Total Amount Paid in July', $('#piechart_3d').data('jul_total_amount')],
          ['Total Amount Paid in August', $('#piechart_3d').data('aug_total_amount')],
          ['Total Amount Paid in September', $('#piechart_3d').data('sep_total_amount')],
          ['Total Amount Paid in October', $('#piechart_3d').data('oct_total_amount')],
          ['Total Amount Paid in November', $('#piechart_3d').data('nov_total_amount')],
          ['Total Amount Paid in December', $('#piechart_3d').data('dec_total_amount')],
        ]);
