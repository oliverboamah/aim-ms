                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card-columns">
                                    ...
                                    <a href="<?php echo base_url('Foreman/foreman_staff'); ?>">
                                    ...
                                    <a href="<?php echo base_url('Foreman/logs'); ?>">
                                    <div class="card" style=" padding: 10px 10px 10px 10px;">
                                        <img class="card-img-top img-responsive" src="<?php echo base_url('asset/img/stock.png'); ?>" alt="Card image cap">
                                        <div class="card-body">
                                            <h3 class="card-title">Logs</h3>
                                            <p class="card-text">Record buyings</p>
                                        </div>
                                    </div>
                                    </a>
                                  
                                    <a href="<?php echo base_url('Foreman/transactions'); ?>">
                                    <div class="card" style=" padding: 10px 10px 10px 10px;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Manage daily accounts</p>
