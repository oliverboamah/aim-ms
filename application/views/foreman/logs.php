...
<h5 class="card-header">4FT Pieces</h5>
                                ...
                                ?>
                                    ...
                                    <button style="float: right" href="#" class="btn btn-secondary" data-toggle="modal" data-target="#add_stock">
                                Add New Logs</button>
                           <br/><br/><br/>
                                    <!-- Export Data -->
...
foreach ($log_info as $record) {
    ...
    $url_view = base_url('Foreman/logs_item/' . $record->log_info_id);
    echo "
            <tr>
        ...
        ";
               ...
               if($hours <= 24) {
                ...
                $url_delete = base_url('LogsForeman/delete_permission/' . $record->log_info_id);
                   echo "
